            ...
            <section className=''>
                <div className=" container mx-auto px-16 py-10">
                    ...
                    <div className="flex gap-2">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 px-8 bg-gray-50 py-10 rounded-md" style={{backgroundColor: mode === 'dark' ? 'gray' : ''}}>
                            <div className="h-full text-center">
                                <img alt="testimonial" className="w-28 h-28 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="https://ecommerce-sk.vercel.app/img/kamal.png" />
                        ...
                        <div className="lg:w-1/3 lg:mb-0 px-8 bg-gray-50 py-10 rounded-md" style={{backgroundColor: mode === 'dark' ? 'gray' : ''}}>
                            <div className="h-full text-center">
                                <img alt="testimonial" className="w-28 h-28 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQL-L1UhpS9glJRsLpcu8L2COL88RL9e_JIZw&usqp=CAU" />
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 px-8 py-10 bg-gray-50 rounded-md" style={{backgroundColor: mode === 'dark' ? 'gray' : ''}}>
                            <div className="h-full text-center">
                                <img alt="testimonial" className="w-28 h-28 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="https://cdn-icons-png.flaticon.com/128/2763/2763444.png" />
