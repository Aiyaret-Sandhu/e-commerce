            ...
            <section className=''>
                <div className=" container mx-auto px-16 py-10">
                    ...
                    <div className="flex gap-2">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 py-16 px-8 bg-gray-100 rounded-md" style={{backgroundColor: mode === 'dark' ? 'gray' : ''}}>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 py-16 px-8 bg-gray-100 rounded-md" style={{backgroundColor: mode === 'dark' ? 'gray' : ''}}>
                            <div className="h-full text-center">
